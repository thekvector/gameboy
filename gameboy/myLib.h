...
void delay(int n);
void drawImage3(int startRow, int startCol, int width, int height, const u16* image);
void undrawImage3(int startRow, int startCol, int width, int height, const u16* image);
void waitForVblank();
